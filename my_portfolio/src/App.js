  ...
  return (
    ...
    <div className="App">
      ...
      <section className='skills'>
        ...
        <div className='language-title'><h3>LANGUAGES</h3></div>
        ...
        <div className='application-title'><h3>APPLICATIONS</h3></div>
        ...
        <div className='database-title'><h3>SERVERS AND DATABASES</h3></div>
      ...
      <section className='contact'>
        ...
        <div className='contact-form'>
          <div className='github-div'><a className='github-link' href='https://github.com/sherget15'><Github color='black' size={75} /></a></div>
          ...
          <div className='gmail-div'><a className='gmail-link' href='mailto:herget06@gmail.com'><Gmail color='red' size={75} /></a><h6>herget06@gmail.com</h6></div>
      </div>
